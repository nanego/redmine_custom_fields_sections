...
module RedmineCustomFieldsSections::Helpers
...
CustomFieldsHelper.prepend RedmineCustomFieldsSections::Helpers::CustomFieldsHelper
ActiveSupport.on_load(:action_view) { prepend CustomFieldsHelper }
